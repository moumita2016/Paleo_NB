...
Notice "read.csv" rather than "read.csv2", indicating the file comes from Moumita's anglo system

load("foran.RData")
dim(foran) # 141 x 63, 141 x 64 after addition of "River" variable below
...
foran$River=as.factor(foran$River)
summary(foran$River)
...
From file WaughCoreIsotopes.xls, I delete erroneous Org data (values
too low) and replace them with those computed from a pivot table based
on the Waugh2009 datasheet in file
CarotteMasseVolumique_2010_2012.ods.

- 2009 Waugh core: organic weight, CRS age estimates, isotopes, but no
pigments

- 2012 Waugh core: pigments, but no isotopes...

Use function "strwrap" to create explanatory text that can be saved with data file

## d15N vs. d13C plot for Waugh 2009, 2018-05-16

```{r}
W2009=read.delim2(("C:/Users/alain/Documents/RECHERCHE_Labos_GIZC/_Base_donnees/Fichiers_txt/Waugh2009.txt"),header=TRUE)
dim(W2009) # 12 x 10
fileinfoap=strwrap("Waugh2009.txt created 2018-05-16 from WaughCoreIsotopes.xls")
fileinfoap
class(fileinfoap)
save(fileinfoap,W2009,file=("W2009.RData"))
names(W2009)

plot(d15N~d13C,data=W2009,type="b",pch=c(1:12),main="2018-05-16 for Waugh 2009")
legend("bottomright",legend=W2009$CRS_year,pch=c(1:12))

```

## Organic content Waugh 2009 vs. 2012, 2018-05-16

```{r}

summary(Waugh2012$Org_cont_pct)
Waugh2012=subset(foran,grepl("Pokemouche_amont_Waugh",SampleName))
dim(Waugh2012)
plot(Waugh2012$Org_cont_pct~Waugh2012$CRS_Binford,type="b", pch=2,lty=2)


plot(W2009$Org_cont_pct~W2009$CRS_year,type="b",pch=1,lty=1,ylim=c(0,0.35),main="Waugh 2009 vs. 2012 org. content")
points(Waugh2012$Org_cont_pct~Waugh2012$CRS_Binford,type="b", pch=2,lty=2)
legend("bottomright",legend=c("2009", "2012"),pch=c(1,2),lty=c(1,2))

```

## d13C vs. year for 4 stations 2018-05-16

```{r}

PTup2012=subset(foran,grepl("Petite_Tracadie",SampleName) & !is.na(CRS_Binford))
Malt2012=subset(foran,grepl("Pokemouche_amont_Maltempec",SampleName) & !is.na(CRS_Binford))
Ink2010=subset(foran,grepl("Pokemouche_aval_Lac_Inkerman",SampleName) & !is.na(CRS_Binford))


summary(PTup2012$CRS_Binford)
summary(W2009$CRS_year)
plot(PTup2012$d13C_new~PTup2012$CRS_Binford,type="b", pch="p",lty=1, ylim=c(-20,-30), xlim=c(1840,2015), col=1,main="2018-05-16, d13C seds")
points(Malt2012$d13C_new~Malt2012$CRS_Binford,type="b",pch="M", lty=2, col=2)
points(W2009$d13C~W2009$CRS_year,type="b", pch="W", lty=3, col=3)
points(Ink2010$d13C_new~Ink2010$CRS_Binford,type="b", pch="I", lty=4, col=4)

```

## d15N vs. year for 4 stations

```{r}

plot(PTup2012$d15N~PTup2012$CRS_Binford,type="b", pch="p",lty=1, ylim=c(-10,10), xlim=c(1840,2015), col=1, main="2018-05-16, d15N seds")
points(Malt2012$d15N~Malt2012$CRS_Binford,type="b",pch="M", lty=2, col=2)
points(W2009$d15N~W2009$CRS_year,type="b", pch="W", lty=3, col=3)
points(Ink2010$d15N~Ink2010$CRS_Binford,type="b", pch="I", lty=4, col=4)


```

## d13C vs. d15N for 4 stations, 2018-05-16

```{r}

summary(Ink2010$d15N)

plot(PTup2012$d15N~PTup2012$d13C_new,type="b", pch="p",lty=1, col=1, main="2018-05-16",ylim=c(-10,10),xlim=c(-30,-20))
points(Malt2012$d15N~Malt2012$d13C_new,type="b",pch="M", lty=2, col=2)
points(W2009$d15N~W2009$d13C,type="b", pch="W", lty=3, col=3)
points(Ink2010$d15N~Ink2010$d13C_new,type="b", pch="I", lty=4, col=4)
